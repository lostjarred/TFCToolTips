...
val Tooltipstoadd = {
    ...
    <tfc:metal/double_ingot/black_steel> : doubleIngotTooltop(),
    
    <tfc:metal/double_ingot/blue_steel> : doubleIngotTooltop(),
    <tfc:metal/double_ingot/red_steel> : doubleIngotTooltop(),
